...
```bash
union run --remote llmops_rag/optimize_rag.py run --hpo_configs config/prompt_experiment.yaml
```

Experiment with different chunksizes:

```bash
union run --remote llmops_rag/optimize_rag.py run --hpo_configs config/chunksize_experiment.yaml
```

Experiment with different splitters:

```bash
union run --remote llmops_rag/optimize_rag.py run --hpo_configs config/splitter_experiment.yaml
```
