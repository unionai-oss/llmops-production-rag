...
```bash
union run --remote llmops_rag/vector_store.py create --include_union --limit 100
```
...
```bash
union run --remote llmops_rag/vector_store.py create_knowledge_base --include_union --limit 100
```
...
**👉 TODO: run LLM as judge workflow**
